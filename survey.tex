...
\item\textit{Sensibilidade:} É um valor que mede a variação máxima do resultado de uma função (ou consulta) ao adicionar ou remover um único registro do conjunto de dados.
\begin{equation}
    \Delta f = \max{D,D'  ||f (D) - f (D')||}
\end{equation}
A sensibilidade do mecanismo de Laplace é representada pela norma L1, enquanto a sensibilidade do mecanismo Gaussiano é representada pela norma L2.
\end{enumerate}
